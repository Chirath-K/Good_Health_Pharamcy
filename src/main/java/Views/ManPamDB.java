 ...
 * @author Chirath
 */
public class ManPamDB extends javax.swing.JFrame {
    ...
    public void showPDB(String IDx) {
        try {
            ...
            while (rs.next()) {
                ...
                String tbData[] = {Cname, Sdate, Edate, pdf};
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        txtTelephone.setText("");
        txtEmail.setText("");
        jTable1.setModel(new DefaultTableModel(null, new String[]{Cname, Sdate, Edate, pdf}));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManPamDB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
